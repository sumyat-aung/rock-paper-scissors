...
const btns = document.querySelectorAll(".btn"); // all 3 btns

const beforePlaying = document.getElementById("game");
const afterPlaying = document.getElementById("selection");
...
// setting user choice and computer choice after user click
btns.forEach((button) => {
  button.addEventListener("click", function () {
    userChoice = button.getAttribute("id");
    computerChoice = gameArray[randomChoice()];
    checkWinner();
...
function checkWinner() {
  ...
  beforePlaying.style.display = "none";
...
playAgain.addEventListener("click", () => {
  beforePlaying.style.display = "flex";
...
// displaying what user and computer choose

function updateSelection(selectEl, choice) {
  selectEl.classList.remove("rock");
  selectEl.classList.remove("paper");
  selectEl.classList.remove("scissors");

  selectEl.classList.add(choice);

  if (choice === "scissors") {
    selectEl.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="51" height="58">
    <path
      fill="#3B4262"
    ...
    selectEl.innerHTML = ` <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48">
    <path
      fill="#3B4262"
    ...
    selectEl.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="49" height="59">
    <path
      fill="#3B4262"
